...
import { Send, Calendar, Mail, Phone, Instagram, Youtube, Linkedin } from 'lucide-react';
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-1 gap-6 md:gap-8">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-base md:text-lg font-bold">hello@estherogo.com</p>
                </div>
              </motion.div>
              <motion.div 
                whileHover={{ x: 10 }}
              ...
              >
                ...
                <div>
                  <p className="text-[10px] font-mono uppercase tracking-widest opacity-40">Booking</p>
                  <p className="text-base md:text-lg font-bold">calendly.com/estherogo</p>
                </div>
              </motion.div>
              <motion.div 
                whileHover={{ x: 10 }}
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-base md:text-lg font-bold">+234 800 000 0000</p>
                </div>
              </motion.div>
            </div>
