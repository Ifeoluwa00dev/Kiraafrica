...
import { Send, Calendar, Mail, Phone, Instagram, Linkedin, Facebook } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 md:gap-20">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-display font-bold mt-4 mb-8 leading-tight">
              Let's Create <br />Something <span className="text-brand-primary italic">Rhythmic</span>
            </h2>
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input name="from_name" type="text" required className="w-full bg-brand-light border-none rounded-2xl p-4 md:p-5 focus:ring-2 focus:ring-brand-primary/20 transition-all text-sm" placeholder="John Doe" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase tracking-widest opacity-60 ml-1">Email Address</label>
                  <input name="from_email" type="email" required className="w-full bg-brand-light border-none rounded-2xl p-4 md:p-5 focus:ring-2 focus:ring-brand-primary/20 transition-all text-sm" placeholder="john@example.com" />
                </div>
              </div>

              <div className="space-y-2">
                <label className="text-[10px] font-bold uppercase tracking-widest opacity-60 ml-1">Service Interest</label>
                <select name="service" className="w-full bg-brand-light border-none rounded-2xl p-4 md:p-5 focus:ring-2 focus:ring-brand-primary/20 transition-all text-sm appearance-none">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input name="event_date" type="date" className="w-full bg-brand-light border-none rounded-2xl p-4 md:p-5 focus:ring-2 focus:ring-brand-primary/20 transition-all text-sm" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase tracking-widest opacity-60 ml-1">Event Type</label>
                  <select name="event_type" className="w-full bg-brand-light border-none rounded-2xl p-4 md:p-5 focus:ring-2 focus:ring-brand-primary/20 transition-all text-sm appearance-none">
              ...
              <div className="space-y-2">
                ...
                <input name="event_location" type="text" className="w-full bg-brand-light border-none rounded-2xl p-4 md:p-5 focus:ring-2 focus:ring-brand-primary/20 transition-all text-sm" placeholder="City, Country" />
              </div>

              <div className="space-y-2">
                <label className="text-[10px] font-bold uppercase tracking-widest opacity-60 ml-1">Message</label>
                <textarea name="message" rows={4} className="w-full bg-brand-light border-none rounded-2xl p-4 md:p-5 focus:ring-2 focus:ring-brand-primary/20 transition-all text-sm" placeholder="Tell me about your project..."></textarea>
              </div>

              {/* Status Messages */}
              {status === 'success' && (
                <div className="bg-green-50 text-green-700 rounded-2xl p-4 text-sm font-bold text-center">
                  ✅ Message sent! We'll be in touch soon.
                </div>
              )}
              {status === 'error' && (
                <div className="bg-red-50 text-red-700 rounded-2xl p-4 text-sm font-bold text-center">
              ...
              <motion.button
                ...
                className="w-full bg-brand-primary text-white py-5 rounded-2xl font-bold uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-brand-dark transition-all shadow-xl shadow-brand-primary/20 disabled:opacity-60 disabled:cursor-not-allowed"
              >
